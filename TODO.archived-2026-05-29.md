...
_Updated: Feb 24, 2026 — TAGITCore upgraded to UUPS proxy (T20)_
...
_Updated: Mar 2, 2026 — TAGITPaymaster deployed_

| Contract       | Address                                    |
| -------------- | ------------------------------------------ |
| TAGITPaymaster | 0xBbB9f7dB1C38Af7998b511d8026042755Eb4F4C4 |

_Other Arbitrum Sepolia contracts pending deployment._
