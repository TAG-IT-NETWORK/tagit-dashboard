...
// NIST CSF 2.0 Deployment - Updated Feb 24, 2026
// TAGITCore upgraded to UUPS proxy (T20) — all other contracts unchanged
export const CONTRACTS = {
  // Core Contracts (Phase 1)
  // TAGITCore is now a UUPS proxy — address changed from T20 deployment
...
export const START_BLOCKS = {
  TAGITCore: 40045836, // Updated: UUPS proxy deployment (T20)
