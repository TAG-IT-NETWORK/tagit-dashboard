...
export const AGENT_CATALOG: CatalogAgent[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Owner actions from the app: flag, list/delist, recycle (24 h grace) — shipped 2026-09-10",
    ],
    ...wp("§3.2"),
  ...
  },
  {
    ...
    responsibilities: [
      "Recycle rail (lifecycle card)",
      "Component recovery routing",
      "Void & remint for destroyed chips",
      "Owner-side recycle live (24 h grace); IoT bin drop path planned",
    ],
    ...wp("§3.2"),
