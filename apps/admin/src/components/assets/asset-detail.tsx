...
export function AssetDetail({ id, role }: { id: string; role: CatalogRole | null }) {
  return (
    <WagmiGuard>
      <AssetDetailContent id={id} role={role} />
    </WagmiGuard>
  );
}
...
function AssetDetailContent({ id, role }: { id: string; role: CatalogRole | null }) {
